...
crop = [1 256 50 200]; %gabi aug 2021 to register neuron silencing dataset
...
switch scanimage %changed for SI4 Gabi 270616
    ...
    case 'SI5a'
        [header,Stack] = load_SI2019a_raw(fullsourcefilename);
end
...
%         savefilenamePlane=[num2str(i) filesep savefilename 'Plane_' num2str(i)];
        savefilenamePlane=[savefilename 'Plane_' num2str(i)];
        if byFrame
            % frame by frame
